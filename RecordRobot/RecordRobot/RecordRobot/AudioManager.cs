...
namespace RecordRobot
{
    public class AudioManager : GameComponent
    {
        ...
        public void LoadSong(string songName, string songPath)
        {
            ...
            try
            {
                _songs.Add(songName, Game1.content.Load<Song>(songPath));
            }
            catch { }
        }
        ...
        public void LoadSound(string soundName, string soundPath)
        {
            ...
            try
            {
                _sounds.Add(soundName, Game1.content.Load<SoundEffect>(soundPath));
            }
            catch (Exception e)
            {
        ...
        public override void Update(GameTime gameTime)
        {
            if (!IsSongActive)
            {
                AudioPlayer.Play((int)MovingObjects.MovingObjectManager.nextColor, Game1.CurrentLevel.LevelNumber % 4 + 1);
            }
